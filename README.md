...
3. Restart the device with filter
4. Your restarted device now has no restrictions, but YouTube and Google are permanently blocked. Use DuckDuckGo to bypass both.
5. To resume normal filtering, restart device outside unblocking times.

# Disclaimer: Filter may restart at any time
